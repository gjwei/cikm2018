...
print('load fasttext')
model = gensim.models.KeyedVectors.load_word2vec_format(fasttext, binary=False)
# data['wmd'] = data.apply(lambda x: wmd(x['question1'], x['question2']), axis=1)


# norm_model = gensim.models.KeyedVectors.load_word2vec_format(fasttext, binary=False)
